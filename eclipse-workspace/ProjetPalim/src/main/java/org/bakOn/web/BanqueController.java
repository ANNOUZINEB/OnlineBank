...
public class BanqueController {
	...
	public String saveCompte(Model model,String cinClient,String nomClient,String prenomClient,String adressClient,String numTelClient,String emailClient) {
		if(nomClient.equals("")) {
			String e="veuillez remplisser tous les champs!";
			model.addAttribute("erreur",e );
		...
		try {
			banqueMetier.creeClient(cinClient, nomClient, prenomClient, adressClient, numTelClient, emailClient);
		} catch (Exception e) {
			model.addAttribute("erreur",e );
